...
/**
 * Strings for component 'glossarylv', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['aliases_help'] = 'Each glossarylv entry can have an associated list of keywords (or aliases). If the entry is auto-linked, then any keywords will also be auto-linked.
...
$string['allowcomments_help'] = 'If enabled, all participants with permission to create comments will be able to add comments to glossarylv entries.';
...
$string['allowprintview_help'] = 'If enabled, students are provided with a link to a printer-friendly version of the glossarylv. The link is always available to teachers.';
$string['andmorenewentries'] = 'and {$a} more new entries.';
$string['answer'] = 'Answer';
$string['approve'] = 'Approve';
$string['approvaldisplayformat'] = 'Approval display format';
$string['approvaldisplayformat_help'] = 'When approving glossarylv items you may wish to use a different display format';
...
$string['attachment_help'] = 'You can optionally attach one or more files to a glossarylv entry.';
...
$string['cnfallowcomments'] = 'Define if a glossarylv will accept comments on entries by default';
$string['cnfallowdupentries'] = 'Define if a glossarylv will allows duplicated entries by default';
...
$string['cnfdefaulthook'] = 'Select the default selection to show when the glossarylv is first viewed';
$string['cnfdefaultmode'] = 'Select the default frame to show when the glossarylv is first viewed.';
...
$string['cnflinkglossaries'] = 'Define if a glossarylv should be automatically linked by default';
...
$string['cnftabs'] = 'Select visible tabs for this glossarylv format';
...
$string['configenablerssfeeds'] = 'This switch will enable the possibility of RSS feeds for all glossaries.  You will still need to turn feeds on manually in the settings for each glossarylv.';
$string['current'] = 'Currently sorted {$a}';
$string['currentglossarylv'] = 'Current glossarylv';
$string['date'] = 'date';
...
$string['destination_help'] = 'Entries can either be imported and added to the current glossarylv or to a new glossarylv, in which case a new glossarylv will be created based on information in the XML file.';
...
$string['entryusedynalink_help'] = 'If site-wide glossarylv auto-linking has been enabled by an administrator and this checkbox is ticked, the entry will be automatically linked wherever the concept words and phrases appear throughout the rest of the course.';
$string['errcannoteditothers'] = 'You cannot edit other people\'s entries.';
$string['errconceptalreadyexists'] = 'This concept already exists. No duplicates allowed in this glossarylv.';
...
$string['explainaddentry'] = 'Add a new entry to the current glossarylv.<br />Concept and definition are mandatory fields.';
$string['explainall'] = 'Shows ALL entries on one page';
$string['explainalphabet'] = 'Browse the glossarylv using this index';
$string['explainexport'] = 'Click on the button below to export glossarylv entries.<br />You can import it anytime you wish in this or other course.<p>Please note that attachments (e.g. images) and authors are not exported.</p>';
...
$string['exportglossarylv'] = 'Export glossarylv';
$string['exporttomainglossarylv'] = 'Export to main glossarylv';
...
$string['filtername'] = 'Glossarylv auto-linking';
$string['fullmatch'] = 'Match whole words only';
$string['fullmatch_help'] = 'This setting specifies whether only whole words will be linked, for example, a glossarylv entry named "construct" will not create a link inside the word "constructivism".';
$string['glossarylv:addinstance'] = 'Add a new glossarylv';
$string['glossarylv:approve'] = 'Approve and undo approved entries';
$string['glossarylv:comment'] = 'Create comments';
$string['glossarylv:export'] = 'Export entries';
$string['glossarylv:exportentry'] = 'Export single entry';
$string['glossarylv:exportownentry'] = 'Export single entry of yours';
$string['glossarylv:import'] = 'Import entries';
$string['glossarylvleveldefaultsettings'] = 'Glossarylv level default settings';
$string['glossarylv:managecategories'] = 'Manage categories';
$string['glossarylv:managecomments'] = 'Manage comments';
$string['glossarylv:manageentries'] = 'Manage entries';
$string['glossarylv:rate'] = 'Rate entries';
$string['glossarylv:view'] = 'View entries';
$string['glossarylvtype'] = 'Glossarylv type';
$string['glossarylvtype_help'] = 'A main glossarylv is a glossarylv in which entries from secondary glossaries can be imported. There can only be one main glossarylv in a course. If glossarylv entry import is not required, all glossaries in the course can be secondary glossaries.';
$string['glossarylv:view'] = 'View glossarylv';
$string['glossarylv:viewallratings'] = 'View all raw ratings given by individuals';
$string['glossarylv:viewanyrating'] = 'View total ratings that anyone received';
$string['glossarylv:viewrating'] = 'View the total rating you received';
$string['glossarylv:write'] = 'Create new entries';
...
$string['isglobal'] = 'Is this glossarylv global?';
$string['isglobal_help'] = 'A global glossarylv has entries which are linked to from throughout the site, rather than only in the course that the glossarylv is in. Only administrators can set a glossarylv as global.';
$string['letter'] = 'letter';
$string['linkcategory'] = 'Automatically link this category';
$string['linkcategory_help'] = 'If glossarylv auto-linking has been enabled and this setting is enabled, the category name will be automatically linked wherever it appears throughout the rest of the course. When a participant follows a category name link, they will be taken to the "Browse by category" page of the glossarylv.';
$string['linking'] = 'Auto-linking';
$string['mainglossarylv'] = 'Main glossarylv';
$string['maxtimehaspassed'] = 'Sorry, but the maximum time for editing this comment ({$a}) has passed!';
$string['modulename'] = 'Glossarylv';
$string['modulename_help'] = 'The glossarylv activity module enables participants to create and maintain a list of definitions, like a dictionary, or to collect and organise resources or information.

A teacher can allow files to be attached to glossarylv entries. Attached images are displayed in the entry. Entries can be searched or browsed alphabetically or by category, date or author. Entries can be approved by default or require approval by a teacher before they are viewable by everyone.

If the glossarylv auto-linking filter is enabled, entries will be automatically linked where the concept words and/or phrases appear within the course.
...
$string['modulename_link'] = 'mod/glossarylv/view';
$string['modulenameplural'] = 'Glossaries';
$string['newentries'] = 'New glossarylv entries';
$string['newglossarylv'] = 'New glossarylv';
$string['newglossarylvcreated'] = 'New glossarylv created.';
$string['newglossarylventries'] = 'New glossarylv entries:';
...
$string['nopermissiontodelinglossarylv'] = 'You can\'t comments in this glossarylv!';
$string['nopermissiontoviewresult'] = 'You can only look at results for your own entries';
$string['notcategorised'] = 'Not categorised';
$string['notapproved'] = 'glossarylv entry is not approved yet.';
$string['numberofentries'] = 'Number of entries';
$string['onebyline'] = '(one per line)';
$string['page-mod-glossarylv-x'] = 'Any glossarylv module page';
$string['page-mod-glossarylv-edit'] = 'Glossarylv add/edit entry page';
$string['page-mod-glossarylv-view'] = 'View glossarylv edit page';
$string['pluginadministration'] = 'Glossarylv administration';
$string['pluginname'] = 'Glossarylv';
...
$string['removeallglossarylvtags'] = 'Remove all glossarylv tags';
$string['resetglossaries'] = 'Delete entries from';
$string['resetglossariesall'] = 'Delete entries from all glossaries';
$string['rssarticles'] = 'Number of RSS recent articles';
$string['rssarticles_help'] = 'This setting specifies the number of glossarylv entry concepts to include in the RSS feed. Between 5 and 20 generally acceptable.';
...
$string['search:activity'] = 'Glossarylv - activity information';
$string['search:entry'] = 'Glossarylv - entries';
$string['searchindefinition'] = 'Search full text';
$string['secondaryglossarylv'] = 'Secondary glossarylv';
...
$string['showalphabet_help'] = 'If enabled, participants can browse the glossarylv by letters of the alphabet.';
$string['showspecial'] = 'Show \'Special\' link';
$string['showspecial_help'] = 'If enabled, participants can browse the glossarylv by special characters, such as @ and #.';
...
$string['tagarea_glossarylv_entries'] = 'Glossarylv entries';
$string['tagsdeleted'] = 'Glossarylv tags have been deleted';
$string['tagtitle'] = 'See the "{$a}" tag';
$string['totalentries'] = 'Total entries';
$string['usedynalink'] = 'Automatically link glossarylv entries';
$string['usedynalink_help'] = 'If site-wide glossarylv auto-linking has been enabled by an administrator and this setting is enabled, the "Add a new entry" form includes the option to automatically link the entry wherever the concept words and phrases appear throughout the rest of the course.';
$string['visibletabs'] = 'Visible tabs';
$string['waitingapproval'] = 'Waiting approval';
$string['warningstudentcapost'] = '(Applies only if the glossarylv is not the main one)';
