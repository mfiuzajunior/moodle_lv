...
function glossarylv_show_entry_TEMPLATE($course, $cm, $glossarylv, $entry, $mode='', $hook='', $printicons=1, $aliases=true) {
    ...
    if ($entry) {
        ...
        echo '<table class="glossarylvpost TEMPLATE">';
        echo '<tr>';
        ...
        //Call the function
        glossarylv_print_entry_approval($cm, $entry, $mode, $approvalalign, $approvalinsidetable);
...
function glossarylv_print_entry_TEMPLATE($course, $cm, $glossarylv, $entry, $mode='', $hook='', $printicons=1) {
    ...
    return glossarylv_show_entry_TEMPLATE($course, $cm, $glossarylv, $entry, $mode, $hook, false, false, false);
