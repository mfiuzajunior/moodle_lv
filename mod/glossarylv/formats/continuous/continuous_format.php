...
function glossarylv_show_entry_continuous($course, $cm, $glossarylv, $entry, $mode='', $hook='', $printicons=1, $aliases=false) {

    global $USER, $OUTPUT;

    echo '<table class="glossarylvpost continuous" cellspacing="0">';
    echo '<tr valign="top">';
    echo '<td class="entry">';
    ...
    if (core_tag_tag::is_enabled('mod_glossarylv', 'glossarylv_entries')) {
        echo $OUTPUT->tag_list(core_tag_tag::get_item_tags(
            'mod_glossarylv', 'glossarylv_entries', $entry->id), null, 'glossarylv-tags');
    }
    $entry->alias = '';
    echo '</td></tr>';
...
function glossarylv_print_entry_continuous($course, $cm, $glossarylv, $entry, $mode='', $hook='', $printicons=1) {
    ...
    glossarylv_show_entry_continuous($course, $cm, $glossarylv, $entry, $mode, $hook, false, false, false);
