...
function glossarylv_show_entry_encyclopedia($course, $cm, $glossarylv, $entry, $mode='',$hook='',$printicons=1, $aliases=true) {
    ...
    if ($entry) {
        echo '<table class="glossarylvpost encyclopedia" cellspacing="0">';
        echo '<tr valign="top">';
        ...
        glossarylv_print_entry_attachment($entry, $cm, null);
...
function glossarylv_print_entry_encyclopedia($course, $cm, $glossarylv, $entry, $mode='', $hook='', $printicons=1) {
    ...
    return glossarylv_show_entry_encyclopedia($course, $cm, $glossarylv, $entry, $mode, $hook, false, false);
