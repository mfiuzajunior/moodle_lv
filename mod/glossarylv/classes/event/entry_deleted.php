...
/**
 * The mod_glossarylv entry deleted event.
 *
...
/**
 * The mod_glossarylv entry deleted event class.
 *
...
class entry_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('evententrydeleted', 'mod_glossarylv');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has deleted the glossarylv entry with id '$this->objectid' in " .
    ...
    public function get_url() {
        ...
        return new \moodle_url("/mod/glossarylv/view.php", $params);
    }
    ...
    public function get_legacy_logdata() {
        ...
        return array($this->courseid, 'glossarylv', 'delete entry',
