...
/**
 * The mod_glossarylv glossarylv category created event.
 *
...
/**
 * The mod_glossarylv glossarylv category created event class.
 *
 * @package    mod_glossarylv
 * @since      Moodle 2.7
 * @copyright  2014 Marina Glancy
...
class category_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventcategorycreated', 'mod_glossarylv');
    }
    ...
    public function get_legacy_logdata() {
        return array($this->courseid, 'glossarylv', 'add category',
