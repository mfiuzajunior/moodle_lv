...
/**
 * The mod_glossarylv glossarylv category updated event.
 *
...
/**
 * The mod_glossarylv glossarylv category updated event class.
 *
 * @package    mod_glossarylv
 * @since      Moodle 2.7
 * @copyright  2014 Marina Glancy
...
class category_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventcategoryupdated', 'mod_glossarylv');
    }
    ...
    public function get_legacy_logdata() {
        return array($this->courseid, 'glossarylv', 'edit category',
