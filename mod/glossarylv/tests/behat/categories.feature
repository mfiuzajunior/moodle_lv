@mod @mod_glossarylv
Feature: Glossarylv entries can be organised in categories
  In order to organise glossarylv entries
  As a teacher
  I need to be able to create, edit and delete categories

  @javascript
  Scenario: Glossarylv entries can be organised in categories and categories can be autolinked
    ...
    And the following "activities" exist:
      ...
      | glossarylv | MyGlossarylv | Test glossarylv description | encyclopedia  | C1     | glossarylv1 |
    And the following "activities" exist:
...
# Log in as admin and enable autolinking filter
    ...
    And I click on "On" "option" in the "Glossarylv auto-linking" "table_row"
    And I log out
# Log in as a teacher and make sure nothing is yet autolinked
    ...
    And "a.glossarylv.autolink" "css_element" should not exist
# Create, edit and delete categories
    And I follow "MyGlossarylv"
    ...
    And I press "Back"
# Add glossarylv entries in categories and outside
    And I add a glossarylv entry with the following data:
...
# Check that category is autolinked from the text in the course
    ...
    And I should see "CategoryAutoLinks" in the "a.glossarylv.autolink" "css_element"
    And I should see "CategoryNoLinks"
