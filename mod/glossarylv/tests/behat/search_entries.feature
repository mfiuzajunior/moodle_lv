@mod @mod_glossarylv
Feature: Glossarylv entries can be searched or browsed by alphabet, category, date or author
  In order to find entries in a glossarylv
  As a user
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | glossarylv | Test glossarylv name | Test glossarylv description | fullwithauthor | C1     | g1       |
    And I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I follow "Test glossarylv name"
    And I add a glossarylv entries category named "The ones I like"
    And I add a glossarylv entries category named "All for you"
